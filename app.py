...
class MainWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.current_session_id = self.generate_session()
        ...
        self.settings_page.set_session_id(self.current_session_id)
        self.home_page.set_session_id(self.current_session_id)
